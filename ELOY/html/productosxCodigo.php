...
mysql_select_db($database_conn, $conn);
	...
	$query_rsProd = "SELECT i.cod_item,i.des_item, i.imagen, i.cant_stock, ie.estado FROM ITEMS as i, ITEMS_ESTADO as ie WHERE i.cod_item = ie.cod_item AND ie.eliminado<>1 ORDER BY i.cod_item";
if(isset($_GET['indice'])){
	$query_rsProd = "SELECT i.cod_item,i.des_item, i.cant_stock,ie.estado FROM ITEMS as i, ITEMS_ESTADO as ie WHERE i.cod_item = ie.cod_item AND ie.eliminado<>1 AND i.des_item LIKE '". $_GET['indice'] ."%' ORDER BY i.des_item";
	}
		if(isset($_GET['buscar'])){
			$query_rsProd = "SELECT i.cod_item,i.des_item, i.imagen, i.cant_stock, ie.estado FROM ITEMS as i, ITEMS_ESTADO as ie WHERE i.cod_item = ie.cod_item AND ie.eliminado<>1" ;
	if($_GET['rd1']==0)  $query_rsProd .= " AND i.cod_item LIKE '%". strtoupper($_GET['buscar']) ."%'  ORDER BY i.cod_item"; 
		else
				$query_rsProd .= " AND i.des_item LIKE '%". strtoupper($_GET['buscar']) ."%'  ORDER BY i.des_item"; 
...
function conslink2(){
var urldir;
	 urldir = "productosxCodigo.php?buscar=" + document.form2.txtBuscar.value + "&rd1=";
	if(document.form2.rd1[0].checked) urldir += "0";
	else
		urldir+= "1";
		document.getElementById('linkBuscar').href = urldir;
}		
...
<table>
   <tr>
											  ...
											  <tr>
                                                    ...
                                                    <tr>
														...
														<tr><td><p>&nbsp;</p>
                                                                ...
                                                                <tr>
																  <td ><p class="cont_heading_td">productos
																    <table cellpadding="0" cellspacing="0" border="0" class="cont_heading_table">
                                                                <tr>
                                                                    <td class="line_x"><img alt="" src="images/spacer.gif" width="1" height="1"></td>
                                                                </tr>
	...
	if(document.form2.rd1[0].checked) urldir += '0';
		...
		urldir+= '1';
		document.location.href = urldir;" onSubmit="javascript:
																	var urldir;
	 urldir = 'productosxCodigo.php?buscar=' + document.form2.txtBuscar.value + '&rd1=';
	if(document.form2.rd1[0].checked) urldir += '0';
	else
		urldir+= '1';
		document.location.href = urldir;">
                                                            <label>
                                                            <div align="right">
                                                              <p> Buscar producto: 
                                                                <input name="txtBuscar" type="text" id="txtBuscar">
																  <a href="#" id="linkBuscar" onClick="javascript:conslink2()">
                                                                <img src="images/k.gif" width="32" height="18"></a> </p>
                                                              <p>
                                                                <label>
                                                                <input type="radio" name="rd1" value="0" checked="checked">
Codigo</label>
...
Nombre</label>
                                                              ...
                                                              <tr>
																...
																?>
                                                                    <?php for($i=0; $alfabeto[$i]; $i++){?>
                                                                      <a href="productosxCodigo.php?<?php 
                                                                  ...
                                                                  <form name="form1" method="post" action="adminSetEstadoProd.php">
                                                                    <p><?php if (isset($_SESSION['tipoUsuario']) && $_SESSION['tipoUsuario']==1) {
														  $ac=0;?>
  ...
  <tr  <?php if ($ac == 1) $ac=0; else { echo 'bgcolor="#E6E6E6"'; $ac=1;} ?>>
    <td><div align="center"><?php echo $row_rsProd['cod_item']?></div></td>
    <td><div align="center"><?php echo $row_rsProd['des_item']?></div></td>
	<td><div align="center"><?php echo $row_rsProd['cant_stock']?></div></td>
	<td> 
	    <div align="center"><a href="agrandar.php?imagen=<?php echo substr($row_rsProd['imagen'],11) ?>" target="_blank">Ver imagen</a></div></td>
	</tr>
